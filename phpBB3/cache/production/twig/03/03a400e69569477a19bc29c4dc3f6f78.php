...
/* mcp_topic.html */
class __TwigTemplate_f469bbda3c955242b722d8d6721a8902 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["postrow"]) {
            ...
            // line 98
            echo "\t\t<div class=\"post ";
            if ((twig_get_attribute($this->env, $this->source, $context["postrow"], "S_ROW_COUNT", [], "any", false, false, false, 98) % 2 != 0)) {
                echo "bg1";
            } else {
                echo "bg2";
            }
